...
public class Partition {
	...
	public Partition(int newArraySize) {
	...
	public static void main(String[] args) {
		...
		Partition partitionArray = new Partition(10);
		
		partitionArray.generateRandomArray();
		
		System.out.println(Arrays.toString(partitionArray.theArray));
	...
	public void partitionArray(int pivot) {
		...
		while (true) {
			...
			if (leftPointer >= rightPointer) break;
				...
				System.out.println(theArray[leftPointer] + " is swapped for " + theArray[rightPointer]);
			}
		}
	}
